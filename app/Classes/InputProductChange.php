...
class InputProductChange
{
    public function __construct($data = null)
    {
        if ($data) {
           ...
           $this->content = session()->get('InputProductChange', []);
        }
    }
    public function add(Request $request)
    {
        ...
        session()->put('InputProductChange', $content->toArray());
    }
    ...
    {
        $content = collect(\session()->get('InputProductChange', []));
