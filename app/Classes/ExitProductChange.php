...
class ExitProductChange
{
    public function __construct($data = null)
    {
        if ($data) {
           ...
           $this->content = session()->get('ExitProductChange', []);
        }
    }
    public function add(Request $request)
    {
        ...
        session()->put('ExitProductChange', $content->toArray());
    }
    ...
    {
        $content = collect(session()->get('ExitProductChange', []));
