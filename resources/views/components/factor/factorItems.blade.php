        ...
        <tbody>
            @foreach($items ?: [] as  $key => $item)
                ...
                <tr>
                    ...
                    <td>{{ $item['title']}}</td> 
                    <td> 
                        <button data-id="{{ $item['rowId'] }}" class="btn btn-sm btn-light btn-increase" type="button"  >
                            <i class="fal fa-plus"></i>
                        </button>
                         <span class="fa-num">{{ $item['amount']}}</span>
                         <button  data-id="{{ $item['rowId'] }}"   class="btn btn-sm btn-light btn-decrease" type="button">
                    ...
                    <td>
                        <button data-rowid="{{ $item['rowId'] }}"  class="btn btn-sm btn-danger btn-remove-item" type="button"><i class="fal fa-times"></i></button>
                    </td>
                </tr>
            @endforeach
            <tr>
