    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                ...
                <a class="btn btn-secondary" href="{{ route('panel.inventory.products.index') }}">
                    بازگشت
                </a>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12 col-md-8">
                            ...
                            <a class="btn btn-primary" href="{{ route('panel.inventory.products.edit',$product) }}">
                                ویرایش محصول
                            </a>
                           
                            <form class="d-inline" method="post" action="{{ route('panel.inventory.products.destroy', $product) }}">
                                @csrf
                                @method('delete')
