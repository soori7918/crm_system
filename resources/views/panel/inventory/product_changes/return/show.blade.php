                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-bordered ">
                                ...
                                <tbody>
                                    @foreach ($product_change->return_items as $key => $item)
                                        <tr>
                                            <td>{{$key++}}</td>
                                            <td>{{$item->product->name}}</td>
                                            <td>{{$item->amount}}</td>
                                            <td>{{$item->description ?: '---'}}</td>
                                            <td><span class="fa-num">{{jd($item->return_date , 'Y/m/d')}}  </span></td>
                                            <td>
                                                <span class="fa-num">{{ $item->is_done ? 'برگشت داده شده' : 'برنگشته' }}</span>
                                            </td>
