                ...
                <div class="card shadow-sm">
                    <div class="py-4 px-4 col-lg-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <form method="POST" action="{{ route('panel.inventory.productChanges.exit.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div id="productChangeItems" style="width: 80% ; margin:auto ; margin-top:30px">
                                    @include('components.productChange.exit.cartList')
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addItemForm" action="{{route('panel.inventory.productChanges.exit.add')}}" method="post">
                    @csrf
                    <div class="row">
