                ...
                <div class="card shadow-sm">
                    <div class="py-4 px-4 col-lg-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <form method="POST" action="{{ route('panel.inventory.productChanges.exit.update' , ['exit' => $product_change->id]) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="form-group col-12 col-sm-3">
                                        ...
                                        <div class="form-group col-12 col-sm-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control"  autocomplete="off" id="exit_date_picker" value="{{jd($product_change->exit_date , 'Y/m/d')}}">
                                    ...
                                    {{-- <div class="form-group col-12 col-sm-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control"  autocomplete="off" id="return_date_picker" value="{{jd($product_change->return_date , 'Y/m/d')}}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addItemForm" action="{{route('panel.inventory.productChanges.exit.addItem' , $product_change->id)}}" method="post">
                    @csrf
                    <div class="row">
