                    ...
                    <div class="col-12 py-2">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <a href="{{ route('panel.categories.index') }}" class="btn btn-secondary mr-2">
                                    نمایش همه
                                </a>
                            </div>
                        </div>
                                        ...
                                        <form method="post" action="{{route('panel.categories.destroy' , $category)}}">
                                            ...
                                            @method('delete')
                                             <button type="button" class="btn btn-sm btn-success btn-edit" data-toggle="modal" 
                                                data-id="{{$category->id}}"    
                                                data-attr="{{ route('panel.categories.edit', $category->id) }}" 
                                                data-attr-update="{{ route('panel.categories.update', $category->id) }}" 
