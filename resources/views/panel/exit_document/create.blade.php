        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="d-flex flex-wrap justify-content-between align-items-center py-2 mb-2">
                    <h2 class="m-0 text-dark">سند خروج کالا</h2>
                    <a class="btn btn-secondary" href="{{route('panel.product_changes.index')}}">بازگشت </a>
                </div>
            </div>
        </div>
        <div class="content">
                ...
                <div class="card shadow-sm">
                    <div class="py-4 px-4 col-lg-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <form method="POST" action="{{ route('panel.exit_documents.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-12 col-lg-4">
                                        <label for="return_date_picker" >تاریخ برگشت </label>
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control"  autocomplete="off" id="return_date_picker">
                                            <input type="hidden" class="form-control" id="return_date" name="return_at"> 
                                            <div class="input-group-prepend">
                                                <span class="input-group-text" id="basic-addon1"><i class="fa fa-calendar" aria-hidden="true"></i>
                                                </span>
                                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <form id="addItemForm" action="{{route('panel.exit_documents.add')}}" method="post">
                        @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $('body').on('submit','#addItemForm', function(e) {
            ...
            $.get("{{ route('panel.exit_documents.increase') }}",{
                rowId: $(this).data('id'),
            }).done(response => {
            ...
            $.get("{{ route('panel.exit_documents.decrease') }}",{
                rowId: $(this).data('id'),
            }).done(response => {
                $('#productChangeItems').html(response)
            }).fail(error => {
            ...
            $.get("{{ route('panel.exit_documents.remove') }}",{
