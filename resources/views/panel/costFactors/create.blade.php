        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="d-flex flex-wrap justify-content-between align-items-center py-2 mb-2">
                    <h2 class="m-0 text-dark">ثبت فاکتور هزینه</h2>
                ...
                <div class="card shadow-sm">
                    <div class="py-4 px-4 col-lg-12">
                        ...
                        <div class="col-12 col-sm-12 col-md-12">
                            <form method="POST" action="{{ route('panel.cost_factors.store') }}" enctype="multipart/form-data">
                                @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12 col-sm-12">
                                            ...
                                            <textarea name="address" id="address" cols="30" class="form-control" placeholder="آدرس را وارد نمایید" rows="2"></textarea>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addItemForm" method="POST" action="{{ route('panel.costFactor.addItem') }}">
                    @csrf
                    <div class="row">
    ...
    <div class="modal fade" id="addPayment" tabindex="-1" role="dialog" aria-labelledby="addPaymentTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addPaymentForm" action="{{route('panel.costFactor.addPayment')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-6 form-group">
...
@section('scripts')
    ...
    <script>
        ...
        $('body').on('click','.btn-remove-item', function() {
            $.post("{{ route('panel.costFactor.removeItem') }}",{
                _token: "{{ csrf_token() }}",
            ...
            $.post("{{ route('panel.costFactor.removePayment') }}",{
                _token: "{{ csrf_token() }}",
            ...
            $.get("{{ route('panel.costFactor.increase') }}",{
            ...
            $.get("{{ route('panel.costFactor.decrease') }}",{
                rowId: $(this).attr("data-id"),
            }).done(response => {
                $('#factorItems').html(response)
            }).fail(error => {
